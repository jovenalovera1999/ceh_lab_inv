-- $2y$10$91FFYLJt2BCdiaK0mDHbTe0ER
--
-- // Login
--
USE `ceh_lab_inv_db`;
...
BEGIN
    ...
    CAST(AES_DECRYPT(password, '$2y$10$91FFYLJt2BCdiaK0mDHbTe0ER') AS CHAR), user_type FROM ceh_lab_inv_db.users
    INNER JOIN ceh_lab_inv_db.accounts ON ceh_lab_inv_db.users.id = ceh_lab_inv_db.accounts.id WHERE username = p_username AND
    CAST(AES_DECRYPT(password, '$2y$10$91FFYLJt2BCdiaK0mDHbTe0ER') AS CHAR) = p_password;
...
BEGIN
    ...
    VALUES(p_user_id, p_username, AES_ENCRYPT(p_password, '$2y$10$91FFYLJt2BCdiaK0mDHbTe0ER'), p_user_type);
END$$
...
BEGIN
    ...
    telephone_number = p_telephone_number, email = p_email, username = p_username, password = AES_ENCRYPT(p_password, '$2y$10$91FFYLJt2BCdiaK0mDHbTe0ER'),
...
BEGIN
	SELECT id, item, brand, supplier, quantity, unit_of_quantity, qty, unit_of_qty, CAST(AES_DECRYPT(unit_cost, '$2y$10$91FFYLJt2BCdiaK0mDHbTe0ER') AS CHAR), 
    CAST(AES_DECRYPT(total_cost, '$2y$10$91FFYLJt2BCdiaK0mDHbTe0ER') AS CHAR), exp_rgt_quantity, exp_rgt_unit,
    CAST(AES_DECRYPT(exp_rgt_cost, '$2y$10$91FFYLJt2BCdiaK0mDHbTe0ER') AS CHAR), expiration_date FROM ceh_lab_inv_db.supplies WHERE id = p_id;
END$$
...
BEGIN
    ...
    CONCAT('₱', FORMAT(CAST(AES_DECRYPT(unit_cost, '$2y$10$91FFYLJt2BCdiaK0mDHbTe0ER') AS CHAR), 2)), 
    CONCAT('₱', FORMAT(CAST(AES_DECRYPT(total_cost, '$2y$10$91FFYLJt2BCdiaK0mDHbTe0ER') AS CHAR), 2)), DATE_FORMAT(expiration_date, '%m/%d/%y'),
    CONCAT(DATEDIFF(expiration_date, NOW()), ' Days Left'), CONCAT(exp_rgt_quantity, ' ', exp_rgt_unit),
    CONCAT('₱', FORMAT(CAST(AES_DECRYPT(exp_rgt_cost, '$2y$10$91FFYLJt2BCdiaK0mDHbTe0ER') AS CHAR), 2)), DATE_FORMAT(created_at, '%m/%d/%y'),
...
BEGIN
    ...
    CONCAT(exp_rgt_quantity, ' ', exp_rgt_unit), CONCAT('₱', FORMAT(CAST(AES_DECRYPT(exp_rgt_cost, '$2y$10$91FFYLJt2BCdiaK0mDHbTe0ER') AS CHAR), 2)),
...
BEGIN
    ...
    VALUES(p_item, p_brand, p_supplier, p_quantity, p_unit_of_quantity, p_qty, p_unit_of_qty, AES_ENCRYPT(p_unit_cost, '$2y$10$91FFYLJt2BCdiaK0mDHbTe0ER'),
    AES_ENCRYPT(p_total_cost, '$2y$10$91FFYLJt2BCdiaK0mDHbTe0ER'), p_expiration_date);
END$$
...
BEGIN
    ...
    VALUES(p_item, p_brand, p_supplier, p_quantity, p_unit_of_quantity, p_qty, p_unit_of_qty, AES_ENCRYPT(p_unit_cost, '$2y$10$91FFYLJt2BCdiaK0mDHbTe0ER'),
    AES_ENCRYPT(p_total_cost, '$2y$10$91FFYLJt2BCdiaK0mDHbTe0ER'));
END$$
...
BEGIN
    ...
    unit_cost = AES_ENCRYPT(p_unit_cost, '$2y$10$91FFYLJt2BCdiaK0mDHbTe0ER'),
    total_cost = AES_ENCRYPT(p_total_cost, '$2y$10$91FFYLJt2BCdiaK0mDHbTe0ER'), expiration_date = p_expiration_date, updated_at = CURRENT_TIMESTAMP WHERE id = p_id;
END$$
...
BEGIN
	UPDATE ceh_lab_inv_db.supplies SET item = p_item, brand = p_brand, supplier = p_supplier, quantity = p_quantity, unit_of_quantity = p_unit_of_quantity, qty = p_qty, unit_of_qty = p_unit_of_qty,
    unit_cost = AES_ENCRYPT(p_unit_cost, '$2y$10$91FFYLJt2BCdiaK0mDHbTe0ER'),
    total_cost = AES_ENCRYPT(p_total_cost, '$2y$10$91FFYLJt2BCdiaK0mDHbTe0ER'), updated_at = CURRENT_TIMESTAMP WHERE id = p_id;
END$$
...
BEGIN
    ...
    exp_rgt_cost = AES_ENCRYPT(p_exp_rgt_cost, '$2y$10$91FFYLJt2BCdiaK0mDHbTe0ER'), updated_at = CURRENT_TIMESTAMP WHERE id = p_id;
END$$
...
BEGIN
    ...
    CONCAT('₱', FORMAT(CAST(AES_DECRYPT(unit_cost, '$2y$10$91FFYLJt2BCdiaK0mDHbTe0ER') AS CHAR), 2)) AS 'unit_cost', 
...
BEGIN
    ...
    SET password = AES_ENCRYPT(p_password, '$2y$10$91FFYLJt2BCdiaK0mDHbTe0ER'), ceh_lab_inv_db.users.updated_at = CURRENT_TIMESTAMP,
